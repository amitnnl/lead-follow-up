...
<aside id="sidebar"
    ...
    <nav class="flex-1 px-3.5 py-5 space-y-1.5 sidebar-nav overflow-y-auto">
        ...
        <a href="<?= BASE_URL ?>/followups/index.php"
        ...
        <a href="<?= BASE_URL ?>/agents/index.php"
        ...
        <a href="<?= BASE_URL ?>/dealers/index.php"
        ...
        <a href="<?= BASE_URL ?>/financers/index.php"
        ...
        <a href="<?= BASE_URL ?>/commissions/index.php"
    ...
    <div class="px-5 py-4 border-t border-slate-900/60 bg-slate-950/40">
        <div class="flex items-center gap-3">
            ...
            <a href="<?= BASE_URL ?>/logout.php" class="text-slate-400 hover:text-red-400 transition-colors p-2 rounded-lg hover:bg-white/5" title="Logout">
