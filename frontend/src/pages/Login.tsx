...
function DealPreviewCard({ title, model, amount, status, badgeColor, delay }: {
  ...
  return (
    <div
      ...
      className={`group relative bg-white/95 dark:bg-[#111622]/95 hover:bg-white dark:hover:bg-[#162230] border border-slate-200/90 dark:border-slate-800/80 hover:border-primary-400 dark:hover:border-primary-500/60 rounded-2xl p-4 shadow-sm hover:shadow-md backdrop-blur-xl transition-all duration-300 cursor-pointer animate-float ${
        hovered ? 'scale-[1.02] -translate-y-1 shadow-primary-500/10 dark:shadow-primary-500/20' : ''
      }`}
      style={{ animationDelay: delay }}
    >
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-primary-50 dark:bg-primary-500/15 border border-primary-100 dark:border-primary-500/30 flex items-center justify-center text-primary-600 dark:text-primary-400 font-black text-xs group-hover:bg-gradient-to-br group-hover:from-primary-600 group-hover:to-violet-600 group-hover:text-white transition-all duration-300">
    ...
    <div className="min-h-screen flex bg-slate-50 dark:bg-[#0B0F19] text-slate-800 dark:text-slate-100 font-sans select-none overflow-hidden relative">
      ...
      <div className="absolute top-6 right-6 z-50">
        <button
          onClick={toggleTheme}
          type="button"
          className="p-2.5 rounded-2xl bg-white/80 dark:bg-[#111622]/80 border border-slate-200/80 dark:border-slate-800 hover:border-primary-400 dark:hover:border-primary-500 text-slate-500 dark:text-slate-300 hover:text-primary-600 dark:hover:text-primary-400 backdrop-blur-xl shadow-md transition-all cursor-pointer"
      ...
      <div className="hidden lg:flex lg:w-[56%] xl:w-[58%] order-2 relative flex-col justify-between p-10 xl:p-14 z-10">
        ...
        <div className="flex items-center gap-3.5">
          <div className="w-11 h-11 bg-gradient-to-br from-primary-600 via-violet-600 to-cyan-500 rounded-2xl flex items-center justify-center font-black text-white text-base shadow-md shadow-primary-500/20 ring-1 ring-white/60 dark:ring-slate-700">
            {logoLetters}
          </div>
          <div>
            <h1 className="text-lg font-black text-slate-900 dark:text-white tracking-tight flex items-center gap-2">
              ...
              <span className="text-[10px] uppercase font-extrabold tracking-widest bg-primary-50 dark:bg-primary-500/15 text-primary-700 dark:text-primary-400 border border-primary-200 dark:border-primary-500/30 px-2 py-0.5 rounded-full">
                Enterprise v2.6
              </span>
            </h1>
        ...
        <div className="my-auto space-y-7 max-w-xl py-6">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-primary-50 dark:bg-primary-500/15 border border-primary-200/80 dark:border-primary-500/30 rounded-full text-xs font-bold text-primary-700 dark:text-primary-400 mb-4 animate-pulse shadow-sm">
            ...
            <h2 className="text-3xl xl:text-4xl font-black text-slate-900 dark:text-white tracking-tight leading-[1.15] mb-3">
              ...
              <span className="bg-gradient-to-r from-primary-600 via-violet-600 to-teal-600 dark:from-primary-400 dark:via-violet-400 dark:to-teal-400 bg-clip-text text-transparent">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
              <span>ðŸ”¥ Live Deal Pipeline Simulator (Hover for IRR & Payouts)</span>
      ...
      <div className="w-full lg:w-[44%] xl:w-[42%] order-1 flex flex-col justify-center min-h-screen relative p-6 sm:p-10 lg:p-12 z-10">
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="flex lg:hidden items-center gap-3 mb-8">
            <div className="w-10 h-10 bg-gradient-to-br from-primary-600 to-violet-600 rounded-xl flex items-center justify-center font-black text-white text-sm shadow-md shadow-primary-500/20">
              {logoLetters}
            </div>
            <div>
          ...
          <div className="bg-white/95 dark:bg-[#111622]/95 md:bg-white/90 dark:md:bg-[#111622]/85 backdrop-blur-2xl border border-slate-200/90 dark:border-slate-800 rounded-3xl p-7 sm:p-9 shadow-[0_20px_50px_-15px_rgba(79,70,229,0.12)] dark:shadow-[0_20px_50px_-15px_rgba(0,0,0,0.6)] relative overflow-hidden">
            ...
            <div className="absolute top-0 inset-x-0 h-1.5 bg-gradient-to-r from-primary-600 via-violet-600 to-cyan-500 dark:from-primary-400 dark:via-violet-400 dark:to-cyan-400" />

            {/* Back Link */}
            <Link to="/" className="inline-flex items-center gap-1.5 text-xs font-bold text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 mb-6 transition-colors group">
            ...
            <div className="mb-6">
              <h2 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight flex items-center gap-2">
                Sign In <Sparkles className="w-5 h-5 text-primary-600 dark:text-primary-400" />
              </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-10 py-3 bg-slate-50 dark:bg-[#0e131d] border rounded-xl text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 outline-none transition-all font-semibold ${
                      emailValid && email
                        ...
                        : 'border-slate-200 dark:border-slate-700 focus:border-primary-600 dark:focus:border-primary-400 focus:bg-white dark:focus:bg-[#111622] focus:ring-4 focus:ring-primary-600/10'
                    }`}
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <a href="#forgot" className="text-xs text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-bold transition-colors">
                    Forgot Password?
                  </a>
                </div>
                <div className="relative">
              ...
              <div className="flex items-center justify-between pt-1">
                <label className="flex items-center gap-2 text-xs font-semibold text-slate-600 dark:text-slate-400 cursor-pointer select-none">
                  <input
                    type="checkbox"
                    defaultChecked
                    className="w-4 h-4 rounded bg-white dark:bg-[#0e131d] border-slate-300 dark:border-slate-700 text-primary-600 focus:ring-primary-500 cursor-pointer accent-primary-600"
                  />
              ...
              <button
                ...
                className={`w-full py-3.5 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2 mt-3 relative overflow-hidden group ${
                  canSubmit
                    ? 'bg-gradient-to-r from-primary-600 via-violet-600 to-cyan-600 hover:brightness-110 text-white shadow-lg shadow-primary-500/25 transform hover:-translate-y-0.5 active:translate-y-0 cursor-pointer'
                    : 'bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 border border-slate-200 dark:border-slate-700 cursor-not-allowed'
                }`}
              >
                {isLoading ? (
                  <>
                    <RefreshCw className="w-4 h-4 animate-spin text-primary-200" />
