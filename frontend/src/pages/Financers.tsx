...
function FinancerModal({ 
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} zClassName="z-[9999]" className="bg-white dark:bg-[#0F1420] rounded-2xl md:rounded-3xl shadow-2xl w-full max-w-3xl max-h-[96vh] overflow-hidden flex flex-col my-auto border border-slate-200 dark:border-slate-800">
        <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-slate-50/90 dark:bg-slate-900/80 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">Configure DSA codes, commission rates, and contact SLA details</p>
            </div>
          </div>
          ...
          <div className="p-6 space-y-5 overflow-y-auto flex-1 min-h-0">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1.5">Commission (%)</label>
                  <input 
                    type="number" 
                    step="0.01"
                    min="0"
                    ...
                    className="w-full p-2.5 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl outline-none focus:border-primary-500 font-mono text-sm text-slate-800 dark:text-white" 
                    placeholder="e.g. 1.5" 
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1.5">Primary Contact Person</label>
                  <input 
                    type="text" 
                ...
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1.5">Contact Mobile</label>
                  <input 
                    type="tel" 
                    maxLength={10} 
                    pattern="^\d{10}$" 
              ...
              <div>
                <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1.5">Notes / SLA Terms</label>
                <textarea 
                  rows={2}
