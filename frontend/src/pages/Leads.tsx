  ...
  return (
    <button onClick={onClick}
      className={clsx(
        ...
        active
          ? clsx(cfg.bg, cfg.border, 'border-primary-500 shadow-sm')
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button onClick={() => setIsModalOpen(true)}
            className="inline-flex items-center gap-1.5 px-3 py-2 rounded-md text-xs font-semibold bg-primary-600 hover:bg-primary-700 text-white transition-colors cursor-pointer">
