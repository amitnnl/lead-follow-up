  ...
  return (
    <div className="space-y-6 animate-fade-in text-slate-800 dark:text-slate-100">
      ...
      <div className="hidden print:block w-full text-black font-sans bg-white p-2 text-xs leading-tight">
        ...
        <div className="flex justify-between items-center pb-4 mb-4 border-b border-black">
          <div className="text-left">
            <h2 className="text-lg font-black uppercase tracking-tight">VEHICLE LOAN QUOTATION</h2>
            <p className="text-[10px] text-slate-700 font-mono mt-0.5">Comprehensive Amortization Schedule</p>
          </div>
        ...
        <div className="mb-4">
          <h3 className="text-[10px] font-extrabold uppercase tracking-wider text-slate-900 border-b border-slate-300 pb-1 mb-2">I. CUSTOMER & VEHICLE DETAILS</h3>
          <div className="grid grid-cols-2 gap-x-6 gap-y-2.5">
            <div>
              <span className="font-semibold block text-slate-500 uppercase text-[9px]">Customer Name</span>
              <span className="font-bold text-sm text-slate-900">
                {initialCustomerName || (leadsList.find(l => l.id.toString() === selectedLeadId)?.customer_name) || 'Valued Customer'}
              </span>
            </div>
            <div>
              <span className="font-semibold block text-slate-500 uppercase text-[9px]">Vehicle Model</span>
        ...
        <div className="mb-4">
          <h3 className="text-[10px] font-extrabold uppercase tracking-wider text-slate-900 border-b border-slate-300 pb-1 mb-2">II. KEY FINANCIALS</h3>
          
          <div className="flex items-center justify-between bg-slate-50 border border-slate-200 p-4 rounded-lg mb-3">
            <div>
            ...
            <div className="text-right border-l border-slate-200 pl-4">
              <span className="font-semibold block text-slate-500 uppercase text-[9px] mb-1">Nominal IRR</span>
              <span className="text-xl font-bold">{calculations.nominalAnnualIrr}% p.a.</span>
            </div>
            
            <div className="text-right border-l border-slate-200 pl-4">
              <span className="font-semibold block text-slate-500 uppercase text-[9px] mb-1">Flat Rate Equiv.</span>
              <span className="text-xl font-bold">{calculations.flatRateEquivalent}% p.a.</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-x-4 gap-y-2.5">
            ...
            <div>
              ...
              <span className="font-mono text-xs font-bold">{calculations.tenure} Months</span>
            </div>
            <div>
        ...
        <div className="mb-4">
          ...
          <table className="w-full text-[10px] text-left border border-slate-200 mt-2">
            <thead>
              <tr className="bg-slate-50 uppercase tracking-wider text-slate-500 border-b border-slate-200">
                <th className="p-1.5 border-r border-slate-200 font-bold">Month</th>
                <th className="p-1.5 border-r border-slate-200 font-bold text-right">Opening Balance</th>
                <th className="p-1.5 border-r border-slate-200 font-bold text-right">EMI Payment</th>
                <th className="p-1.5 border-r border-slate-200 font-bold text-right">Principal</th>
                <th className="p-1.5 border-r border-slate-200 font-bold text-right">Interest</th>
                <th className="p-1.5 font-bold text-right">Closing Balance</th>
              </tr>
            </thead>
        ...
        <div className="mt-8 flex justify-between items-center text-[9px] text-slate-500 font-mono uppercase tracking-wide border-t border-slate-200 pt-2">
          <span>Generated by Vehicle Finance Lead Portal</span>
        </div>
      </div>
      ...
      <div className="print:hidden space-y-6">
        ...
        {/* Actions Bar */}
        <div className="flex flex-wrap gap-3 items-center justify-between card p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm rounded-2xl">
